...
public class CartServiceImpl implements CartService {
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        ...
        if (cartItem != null) {
            ...
            if (product.getQuantity() < updatedQuantity) {
                throw new APIException(product.getProductName() + "대한 상품 수량이 부족합니다.");
            }
            ...
            if (product.getQuantity() == 0) {
                throw new APIException(product.getProductName() + "는 품절되었습니다.");
            }
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        if (cartItem == null) {
            throw new APIException("장바구니에 상품이 존재하지 않습니다.");
        }

        int newQuantity = cartItem.getQuantity() + quantity;

        if (newQuantity < 0) {
            throw new APIException("장바구니에 수량이 존재하지 않습니다.");
        }
    ...
    public String createOrUpdateCartWithItems(List<CartItemsDTO> cartItems) {
        ...
        return "장바구니에 상품이 성공적으로 추가/업데이트되었습니다.";
    }
}
